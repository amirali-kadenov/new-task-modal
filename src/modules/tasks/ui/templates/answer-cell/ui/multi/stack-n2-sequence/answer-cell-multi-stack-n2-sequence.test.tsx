...
import { AnswerCellMultiStackN2Sequence as Template } from '.'
...
describe('answerCell.multi.stack.n2.sequence', () => {
  it('фикстура классифицируется в answerCell.multi.stack.n2.sequence', () => {
    expect(classifyAnswerCellTemplate(task)).toBe(
      'answerCell.multi.stack.n2.sequence',
    )
  })

  it('два MathInput + textBefore', () => {
