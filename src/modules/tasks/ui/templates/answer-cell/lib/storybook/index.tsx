...
export type AnswerCellStoryArgs = {
  group: string
  taskId?: string
  grade?: number
}

export type AnswerCellStoryMetaArgs = TaskComponentProps<AnswerCellTask> &
  AnswerCellStoryArgs

const asTextTask = (task: AnswerCellTask): TextTask =>
