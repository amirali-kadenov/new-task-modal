...
export type EquationStoryArgs = {
  group: string
  taskId?: string
  grade?: number
}

export type EquationStoryMetaArgs = TaskComponentProps<EquationTask> &
  EquationStoryArgs

const asTextTask = (task: EquationTask): TextTask => task as unknown as TextTask
