...
export type TestStoryArgs = {
  group: string
  taskId?: string
  grade?: number
}

export type TestStoryMetaArgs = TaskComponentProps<TestTask> & TestStoryArgs

const asTextTask = (task: TestTask): TextTask => task as unknown as TextTask
