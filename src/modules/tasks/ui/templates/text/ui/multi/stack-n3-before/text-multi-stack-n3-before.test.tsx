...
import { TextMultiStackN3Before as Template } from '.'
...
describe('text.multi.stack.n3.before', () => {
  it('фикстура классифицируется в text.multi.stack.n3.before', () => {
    expect(classifyTextTemplate(task)).toBe('text.multi.stack.n3.before')
  })

  it('3 input столбиком с префиксами, без суффиксов', () => {
