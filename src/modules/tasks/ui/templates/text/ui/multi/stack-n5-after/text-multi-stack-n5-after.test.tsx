...
import { TextMultiStackN5After as Template } from '.'
...
describe('text.multi.stack.n5.after', () => {
  it('фикстура классифицируется в text.multi.stack.n5.after', () => {
    expect(classifyTextTemplate(task)).toBe('text.multi.stack.n5.after')
  })

  it('5 input столбиком с суффиксами, без префиксов', () => {
    renderTemplate(Template, task)

    expect(screen.getAllByTestId('math-input')).toHaveLength(5)
  ...
  it('solution-ветка вместо режима ввода', () => {
    renderTemplate(Template, { ...task, solution: makeSolution('1;2;3;4;5') })
