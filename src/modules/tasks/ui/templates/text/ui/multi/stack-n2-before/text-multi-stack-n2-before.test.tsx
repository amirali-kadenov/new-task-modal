...
import { TextMultiStackN2Before as Template } from '.'
...
describe('text.multi.stack.n2.before', () => {
  it('фикстура классифицируется в text.multi.stack.n2.before', () => {
    expect(classifyTextTemplate(task)).toBe('text.multi.stack.n2.before')
  })

  it('2 input столбиком с префиксами, без суффиксов', () => {
