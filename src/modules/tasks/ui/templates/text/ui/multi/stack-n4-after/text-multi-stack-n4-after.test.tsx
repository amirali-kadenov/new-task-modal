...
describe('text.multi.stack.n4.after', () => {
  it('фикстура классифицируется в text.multi.stack.n4.after', () => {
    expect(classifyTextTemplate(task)).toBe('text.multi.stack.n4.after')
  })

  it('4 input столбиком с суффиксами, без префиксов', () => {
    renderTemplate(Template, task)

    expect(screen.getAllByTestId('math-input')).toHaveLength(4)
  ...
  it('solution-ветка вместо режима ввода', () => {
    renderTemplate(Template, { ...task, solution: makeSolution('1;2;3;4') })
