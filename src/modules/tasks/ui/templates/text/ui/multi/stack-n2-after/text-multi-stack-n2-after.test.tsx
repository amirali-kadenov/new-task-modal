...
describe('text.multi.stack.n2.after', () => {
  it('фикстура классифицируется в text.multi.stack.n2.after', () => {
    expect(classifyTextTemplate(task)).toBe('text.multi.stack.n2.after')
  })

  it('2 input столбиком с суффиксами, без префиксов', () => {
