...
describe('text.multi.inline.n5.after', () => {
  it('фикстура классифицируется в text.multi.inline.n5.after', () => {
    expect(classifyTextTemplate(task)).toBe('text.multi.inline.n5.after')
  })

  it('5 input в одну строку с суффиксами', () => {
