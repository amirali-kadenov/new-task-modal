...
import { TextMultiStackN3BeforeAfter as Template } from '.'
...
describe('text.multi.stack.n3.beforeAfter', () => {
  it('фикстура классифицируется в text.multi.stack.n3.beforeAfter', () => {
    expect(classifyTextTemplate(task)).toBe('text.multi.stack.n3.beforeAfter')
  })

  it('3 input столбиком, есть префиксы и суффиксы', () => {
