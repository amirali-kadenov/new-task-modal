...
export type ComparisonStoryArgs = {
  group: string
  taskId?: string
  grade?: number
}

export type ComparisonStoryMetaArgs = TaskComponentProps<ComparisonTask> &
  ComparisonStoryArgs

const asTextTask = (task: ComparisonTask): TextTask =>
