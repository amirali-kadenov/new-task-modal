...
describe('table.multiRow', () => {
  it('фикстура классифицируется в table.multiRow', () => {
    expect(classifyTableTemplate(task)).toBe('table.multiRow')
  })
  ...
  it('solution-ветка вместо режима ввода', () => {
    renderTemplate(Template, {
      ...task,
      solution: makeSolution('575;;3;;20'),
    })
