...
export type FormulaStoryArgs = {
  group: string
  taskId?: string
  grade?: number
}

export type FormulaStoryMetaArgs = TaskComponentProps<FormulaTask> &
  FormulaStoryArgs

const asTextTask = (task: FormulaTask): TextTask => task as unknown as TextTask
