...
describe('formula.after', () => {
  it('фикстура классифицируется в formula.after', () => {
    expect(classifyFormulaTemplate(task)).toBe('formula.after')
  })

  it('формула + input + суффикс', () => {
  ...
  it('solution-ветка вместо режима ввода', () => {
    renderTemplate(Template, { ...task, solution: makeSolution('2') })
