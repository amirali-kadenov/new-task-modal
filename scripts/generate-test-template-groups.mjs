 ...
 * for test UI templates from snapshot task data.
 *
...
function classify(task) {
  ...
  if ('inline' in ai || keys.length) {
    ...
    return `test.multi.${layout}.n${keys.length}.${adornmentOf(b, a)}`
  }
  return `test.${adornmentOf(hasText(ai.before), hasText(ai.after))}`
}
